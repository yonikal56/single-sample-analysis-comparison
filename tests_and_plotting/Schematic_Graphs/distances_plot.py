...
data1 = GLV.generate_models(m, cohorts, '../distances_samples-weakest.json', force=False, sameR=False, bound=0.025)
data2 = GLV.generate_models(m, cohorts, '../distances_samples-weak.json', force=False, sameR=True, bound=0.1)
data3 = GLV.generate_models(m, cohorts, '../distances_samples-medium.json', force=False, sameR=True, bound=0.04)
data4 = GLV.generate_models(m, cohorts, '../distances_samples-regular.json', force=True, sameR=True, bound=0.025)
data5 = GLV.generate_models(m, cohorts, '../distances_samples-strong.json', force=False, sameR=True, bound=0.015)
